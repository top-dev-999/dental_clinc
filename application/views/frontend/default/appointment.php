...
<section class="slice sct-color-2">
    <div class="container container-xs">
        <div class="row">
            <div class="col">
                <form id="booking-form" class="form-default" role="form"
                    ...
                    <button  style="cursor: pointer;" class="g-recaptcha btn btn-styled btn-base-1" 
        data-sitekey="<?php echo $recaptcha[0]->site_key;?>" 
        data-callback='onSubmit' 
        data-action='submit'><i class="fa fa-calendar mr-1"></i> <?php echo get_phrase('book_now');?></button>
                </form>
            </div>
        </div>
    </div>
