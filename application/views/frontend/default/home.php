        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="home-widget widget-1">
                    ...
                    <h4><?php echo get_phrase('hot_line');?></h4>
            ...
            <div class="col-lg-4">
                <div class="home-widget widget-3">
                    ...
                    <ul>
                        <li class="clearfix"><?php echo get_phrase('sunday');?> - <?php echo get_phrase('thursday');?> 
                            <span class="float-right"><?php echo $open[0]->sunday_thursday;?></span></li>
...
<section class="slice sct-color-1 relative">
    <div class="container">
        <div class="section-title section-title--style-1 text-center mb-4">
            <h3 class="section-title-inner text-normal">
                <span><?php echo get_phrase('our_doctors');?></span>
            </h3>
            <span class="section-title-delimiter clearfix d-none"></span>
        </div>
