<div class="row">
    <div class="col-md-12">
        <div class="panel panel-primary" data-collapsed="0">
		    ...
		    <input type="hidden" name="title" value="SERVICE MEMO" />

                <div class="form-group">
                    <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('memo_number'); ?></label>
                ...
                <div class="form-group">
                    <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('gst_percentage'); ?></label>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        <div class="input-group">
                            <span class="input-group-addon"><i class="entypo-info-circled"></i></span>
			    <select name="discount_amount" class="select2">
