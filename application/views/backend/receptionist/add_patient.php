        ...
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <form role="form" class="form-horizontal form-groups" action="<?php echo site_url('receptionist/patient/create'); ?>" 
                    ...
                    <div class="form-group">
                        <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('National ID(Maldivian)'); ?></label>

                        <div class="col-sm-7">
                            <input type="text" name="nid" class="form-control" id="field-1" >
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('Passport No(Foreigner)'); ?></label>

                        <div class="col-sm-7">
                            <input type="text" name="ppno" class="form-control" id="field-1" >
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="field-ta" class="col-sm-3 control-label"><?php echo get_phrase('Atoll/State'); ?></label>

                        <div class="col-sm-7">
                            <input type="text" name="atoll_state" class="form-control" id="field-1" required>
                        </div>
                    </div>
                    
                    <div class="form-group">
                        <label for="field-ta" class="col-sm-3 control-label"><?php echo get_phrase('Island/City'); ?></label>

                        <div class="col-sm-7">
                            <input type="text" name="island_city" class="form-control" id="field-1" required>
                        </div>
                    </div>
