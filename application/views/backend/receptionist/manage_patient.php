...
<table class="table table-bordered table-striped datatable" id="table-2">
    <thead>
        <tr>
            ...
            <th><?php echo get_phrase('nid/ppn');?></th>
    ...
    <tbody>
        <?php foreach ($patient_info as $row) { ?>   
            <tr>
                ...
                <td><?php echo $row['nid']?><?php echo $row['ppno']?></td>
		...
		<td>
                    <a  onclick="showAjaxModal('<?php echo site_url('modal/popup/add_invoice/' . $row['patient_id']);?>');"
                        class="btn btn-info btn-sm">
                            <i class="fa fa-pencil"></i> &nbsp;
                            <?php echo get_phrase('add_memo');?>
                    </a>
