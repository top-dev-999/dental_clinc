                ...
                <td>
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                            <li>
                                <a onclick="showAjaxModal('<?php echo site_url('modal/popup/add_prescription_dental/'.$row['patient_id']);?>');">
                                    <i class="fa fa-pencil"></i> &nbsp;
                                    <?php echo get_phrase('prescription(Dental)'); ?>
                                </a>
                            </li>
                            
                            <li>
                                <a onclick="showAjaxModal('<?php echo site_url('modal/popup/add_prescription/'.$row['patient_id']);?>');">
                                    <i class="fa fa-pencil"></i> &nbsp;
