...
<div class="row">
    <div class="col-md-12">
      ...
      <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('Patient'); ?></label>
            <div class="col-sm-7">
                    ...
                    <div class="form-group">
                        <label for="field-ta" class="col-sm-3 control-label"><?php echo get_phrase('Dental Condition'); ?></label>
                        <div class="col-sm-7">
                              <select id="dental_condition" name="dental_condition" class="select2" required>
                                <option value=""><?php echo get_phrase('select_dental_condition'); ?></option>
                                <?php 
                                $detail_condtion = $this->db->get('dental_condition')->result_array();

                                foreach ($detail_condtion as $row) { ?>
               
           <option value="<?php echo $row['dental_condition_id']; ?>"><?php echo $row['name']; ?></option>
                    ...
                    <div class="form-group">
                        <label for="field-ta" class="col-sm-3 control-label"><?php echo get_phrase('Anotate'); ?></label>
  ...
  <path
    ...
    style="fill:none;stroke:#000000;stroke-width:1;stroke-linecap:butt;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none"/>
  <text xml:space="preserve" x="120.802124" y="100.42228" style="font-size:10.13467216px;font-style:normal;font-weight:normal;line-height:125%;letter-spacing:0px;word-spacing:0px;fill:#000000;fill-opacity:1;stroke:none;font-family:Sans">
    <tspan x="120.802124" y="100.42228">51</tspan>
  </text>
  <text xml:space="preserve" x="100.802124" y="110.42228" style="font-size:10.13467216px;font-style:normal;font-weight:normal;line-height:125%;letter-spacing:0px;word-spacing:0px;fill:#000000;fill-opacity:1;stroke:none;font-family:Sans">
    <tspan x="100.802124" y="110.42228">52</tspan>
  </text>
